      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined }>
        ...
        >
            <View style={styles.main}>
              ...
              <View>
                <Text style={styles.title}>Plataforma de Doações</Text>
                <Text style ={styles.description}>Viabilizamos a troca de produtos e rações, criando uma rede de ajuda e cuidado aos animais.</Text>
              </View>
            </View>
